'''
This script train a U-NET on the data where nerves are present using scale_2 
and no cleaned data. 
'''
...
for epoch in range(nb_epoch):
    ...
    if hist.history['loss'][0] < loss:
        model.save_weights('weights_B2.hdf5', overwrite=True)
...
model.load_weights('weights_B2.hdf5')
